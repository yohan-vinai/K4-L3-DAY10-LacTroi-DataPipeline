...
1. **Dữ liệu bẩn sinh ra Silent Failure:** Việc xóa rỗng tóm tắt và xóa bớt tài liệu (`corruption`) dẫn tới việc Great Expectations phát hiện vi phạm độ dài (`quality signal`), trực tiếp kéo tụt Retrieval Hit Rate từ 1.0 xuống 0.50 và Token F1 từ 1.0 xuống 0.6506 (`agent metric`). RAG Agent không văng ngoại lệ runtime nào mà tự tin trả về kết quả sai lệch.
